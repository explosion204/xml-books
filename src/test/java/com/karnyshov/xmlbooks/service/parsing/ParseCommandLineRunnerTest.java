...
class ParseCommandLineRunnerTest {
    ...
    private static Stream<Arguments> provideTestData() throws FileNotFoundException {
        List<BookFragment> europeanLanguagesFragments = new ArrayList<>() {{
            add(new BookFragment(DUMMY_STRING, SECTION, "The European Languages", "The European languages " +
            ...
            add(new BookFragment(DUMMY_STRING, SECTION, "Grammar", "To achieve this, it would be necessary to have " +
            ...
            add(new BookFragment(DUMMY_STRING, SECTION, "Occidental", "It will be as simple as Occidental; " +
            ...
            add(new BookFragment(DUMMY_STRING, SECTION, "Pronunciation", "The languages only differ in their " +
            ...
            add(new BookFragment(DUMMY_STRING, SECTION, "Coalesce between languages", "If several languages " +
            ...
            add(new BookFragment(DUMMY_STRING, SECTION, "The Family", "The European languages are members " +
        ...
        List<BookFragment> farFarAwayFragments = new ArrayList<>() {{
            add(new BookFragment(DUMMY_STRING, SECTION, "Introduction", "Far far away, behind the word " +
            ...
            add(new BookFragment(DUMMY_STRING, SECTION, "World of Grammar", "It is a paradisematic " +
            ...
            add(new BookFragment(DUMMY_STRING, SECTION, "The Big Oxmox", "The Big Oxmox advised her not " +
            ...
            add(new BookFragment(DUMMY_STRING, SECTION, "Italic Mountains", "When she reached the first " +
            ...
            add(new BookFragment(DUMMY_STRING, SECTION, "Little Blind Text", "The copy warned the " +
            ...
            add(new BookFragment(DUMMY_STRING, SECTION, "Far Away", "And if she hasn’t been rewritten, " +
